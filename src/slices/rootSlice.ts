...
export const selectFeedData = (state: BurgersState) => state.feedData;
export const selectOrders = (state: BurgersState) => state.orders;
export const selectIngredients = (state: BurgersState) => state.ingredients;
export const selectOrderRequest = (state: BurgersState) => state.orderRequest;
export const selectOrderModalData = (state: BurgersState) =>
  state.orderModalData;
export const selectConstructorItems = (state: BurgersState) =>
  state.constructorItems;
export const selectItem = (state: BurgersState) => state.selectedItem;
export const selectOrder = (state: BurgersState) => state.selectedOrder;
export const userDataSelector = (state: BurgersState) => state.user;
export const isAuthCheckedSelector = (state: BurgersState) =>
  state.isAuthChecked;
export const selectIsIngredientsLoading = (state: BurgersState) =>
